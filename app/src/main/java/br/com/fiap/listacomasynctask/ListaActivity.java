package br.com.fiap.listacomasynctask;
...
import br.com.fiap.listacomasynctask.adapter.AndroidAdapter;
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                for (int i = 0; i < jArray.length(); i++) {
                    ...
                    android.setImagem(jsonData.getString(Android.TAG_URL_IMAGEM));
